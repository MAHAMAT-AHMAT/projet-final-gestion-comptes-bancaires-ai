...
- Ajout d’un client  
  ![Ajout client](screenshots/ajout.png)
...
- Console H2 – Clients  
  ![Clients H2](screenshots/Clients_h2.png)
...
- Liste des comptes  
  ![Comptes](screenshots/Comptes.png)

- Console H2 – Comptes  
  ![Comptes H2](screenshots/Comptes_h2.png)
